    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <form method="POST" action="{{ route('medida.storeVoluntariado') }}" data-toggle="validator">
                    {{ csrf_field() }}
                    <div class="panel-body">
                        ...
                        <div class="form-group"> 
                            ...
                            <input name="labor" class="form-control" placeholder="Ingrese direccion" required>
                        </div>
                        <div class="form-group">
